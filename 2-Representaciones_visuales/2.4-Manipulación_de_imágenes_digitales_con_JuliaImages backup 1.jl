...
# ╔═╡ 71e033be-c34d-4426-8248-577a86c491f7
arte_de_pixeles = [
    RGB(0.0,0.7,1.0) RGB(0.0,0.7,1.0) RGB(0.0,0.7,1.0) RGB(0.0,0.7,1.0) RGB(0.0,0.7,1.0) RGB(0.0,0.7,1.0) RGB(0.0,0.7,1.0) RGB(0.0,0.7,1.0) 
    RGB(0.0,0.7,1.0) RGB(0.0,0.7,1.0) RGB(1.0,0.7,0.9) RGB(1.0,0.7,0.9) RGB(1.0,0.7,0.9) RGB(1.0,0.7,0.9) RGB(0.0,0.7,1.0) RGB(0.0,0.7,1.0)
    RGB(0.0,0.7,1.0) RGB(1.0,0.7,0.9) RGB(1.0,0.7,0.9) RGB(1.0,0.7,0.9) RGB(1.0,0.7,0.9) RGB(1.0,0.7,0.9) RGB(1.0,0.7,0.9) RGB(0.0,0.7,1.0)
    RGB(0.0,0.7,1.0) RGB(1.0,0.5,0.7) RGB(1.0,0.7,0.9) RGB(0.0,0.0,0.0) RGB(1.0,0.7,0.9) RGB(0.0,0.0,0.0) RGB(1.0,0.7,0.9) RGB(1.0,0.5,0.7)
    RGB(1.0,0.5,0.7) RGB(1.0,0.7,0.9) RGB(1.0,0.7,0.9) RGB(0.3,0.0,1.0) RGB(1.0,0.7,0.9) RGB(0.3,0.0,1.0) RGB(1.0,0.7,0.9) RGB(1.0,0.5,0.7)
	RGB(1.0,0.5,0.7) RGB(1.0,0.5,0.7) RGB(1.0,0.4,0.7) RGB(1.0,0.7,0.9) RGB(1.0,0.7,0.9) RGB(1.0,0.7,0.9) RGB(1.0,0.4,0.7) RGB(0.0,0.7,1.0)
    RGB(0.0,0.7,1.0) RGB(1.0,0.0,0.0) RGB(1.0,0.5,0.7) RGB(1.0,0.5,0.7) RGB(1.0,0.7,0.9) RGB(1.0,0.7,0.9) RGB(1.0,0.0,0.0) RGB(0.0,0.7,1.0)
    RGB(0.0,0.7,1.0) RGB(1.0,0.0,0.0) RGB(1.0,0.0,0.0) RGB(1.0,0.0,0.0) RGB(0.0,0.7,1.0) RGB(1.0,0.0,0.0) RGB(1.0,0.0,0.0) RGB(0.0,0.7,1.0)]
...
# ╟─768e7b46-f7ef-44f8-b69f-f0a9fd4d797f
# ╠═71e033be-c34d-4426-8248-577a86c491f7
# ╠═cac0ead5-9223-431a-8882-38dbb920b379
# ╟─8270b927-ac96-4e45-8c26-47995b036313
# ╠═3e886602-1dbe-4000-8993-eab5d9edae54
# ╟─47dbad09-c809-4a65-b25b-f3e049efb69f
# ╟─00000000-0000-0000-0000-000000000001
